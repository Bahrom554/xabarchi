        ...
        <div class="row">
            <div class="col-lg-12">
                <figure class="text-center">
                    <img src="{{asset('storage/static/2022/10/19/08/54/lmd3kTIHsu8MFCcXptmX8k5iSfMbEQLX.jpg')}}" alt=""
                        class="img-fluid">
                </figure>
                <hr>
                <div class="text-center">
                    ...
                    <p>nice to meet you and welcome to my world <br>
                        I <i class="fa fa-heart text-primary"></i> traveler, blogger and design enthusias</p>
                </div>
                <hr>
                <div class="wrap__article-detail-content">
                    ...
                    <blockquote class="alignright">
                        <p>Over every mountain there is a path, although it may not be seen from the valley.
                        </p>
                        <footer><cite><a title="Author title" href="#temp_url">Theodore Roethke</a></cite>
                        </footer>
                    </blockquote>
                    <p class="has-drop-cap-container">
                        Fulfilled direction use continual set him propriety continued. Saw met applauded
                        favourite deficient engrossed concealed and her. Concluded boy perpetual old
                        supposing. Farther related bed and passage comfort civilly. Dashwoods see frankness
                        objection abilities the. As hastened oh produced prospect formerly up am.
                    </p>
